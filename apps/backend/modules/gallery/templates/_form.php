    ...
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'gallery/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
...
<?php if (!$form->getObject()->isNew()): ?>
    <?php include_component('photo','photoGallery',array('gallery'=>$form->getObject())) ?>
<?php endif; ?>
