...
<form class="form-horizontal" style="margin-bottom: 0;" action="<?php echo url_for('geolocator_search')?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
